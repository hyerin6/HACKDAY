...
import com.hackday.timeline.post.request.GetMyPostsRequest;
...
public class PostAPIController {
	...
	public @ResponseBody PostsResponse getMyPosts(@RequestBody GetMyPostsRequest getPostsRequest, Authentication authentication) {
